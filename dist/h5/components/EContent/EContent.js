...
let windowHeight = _getSystemInfoSync().windowHeight;
...
export default class EContent extends Taro.Component {
  ...
  render() {
    ...
    return <View className="EContent" style={{ height: `${windowHeight - footerHeight - headerHeight - tabBarBottom}px` }}>
        <View className="refresher" style={downDragStyle}>
          <View className="refresher-holder">
            ...
            {this.refresherConfig.showText ? <View className="down-text">{this.refresherConfig.refreshText[textStatus]}</View> : null}
          </View>
        </View>
